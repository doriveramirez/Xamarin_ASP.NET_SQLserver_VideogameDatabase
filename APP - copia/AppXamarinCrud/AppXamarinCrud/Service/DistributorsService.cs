...
namespace MVVM.Service
{
    public class DistributorsService
    {
        ...
        private const string apiUrl = "http://192.168.1.180:40089/api/Distributors";
        ...
        public async System.Threading.Tasks.Task<bool> Modify(Distributor modelo)
        {
            ...
            try
            {
                ...
                using (client = new HttpClient())
                {
                    ...
                    Uri apiUrl2 = new Uri(string.Format("http://192.168.1.180:40089/api/Distributors/{0}", modelo.Id));
